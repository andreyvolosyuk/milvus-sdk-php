...
class ImportRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           target partition
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $channel_names
     *           channel names for the collection
     *     @type bool $row_based
     *           the file is row-based or column-based
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $files
     *           file paths to be imported
     *     @type \Milvus\Proto\Common\KeyValuePair[]|\Google\Protobuf\Internal\RepeatedField $options
     *           import options, bucket, etc.
     *     @type string $db_name
     *           target database
     ...
     * @return $this
     */
    public function setClusteringInfo($var)
    {
